// Generated by SolidPython 1.1.3 on 2026-01-17 17:39:53
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 0.9000000000) {
					offset(r = 2.0000000000) {
						import(file = "/Users/stan/Library/Mobile Documents/com~apple~CloudDocs/OpenFC/stencil_out/OpenFC-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "/Users/stan/Library/Mobile Documents/com~apple~CloudDocs/OpenFC/stencil_out/OpenFC-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
